...
nome_modelo = 'LeNet-FP32'
diretorio_pai = criar_diretorio_incrementado('resultadosLeNet', nome_modelo)
...
# @track_emissions(project_name="LeNet_original", output_dir=diretorio_carbon)
