...
nome_modelo = 'AlexNet-FP32'
diretorio_pai = criar_diretorio_incrementado('resultadosAlexNet', nome_modelo)
...
# @track_emissions(project_name="AlexNet_original", output_dir=diretorio_carbon)
